...
import {changeValueLab2, changeDataLab2} from 'store/actions'
import {lab2Data} from 'forms/lab2Form'
  ...
  render(){
    ...
    const submissionData = (data) => {
      ...
      if(!this.state.editFlage)
        this.props.submitData(data, 'lab2', this.handleNext, this.props.handleError)
      else
...
const mapDispatchToProps = dispatch => {
  return {
      changeData: (data) => dispatch(changeDataLab2(data)),
      changeValue: (field) => dispatch(changeValueLab2(field)),
