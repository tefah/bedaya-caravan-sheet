  ...
  render(){
    ...
    const submissionData = (data) => {
      ...
      if(!this.state.editFlage)
        this.props.submitData(data, 'lab1', this.handleNext, this.props.handleError)
      else
        this.props.updateData(data.patientID, data, 'updateLab1', this.handleNext, this.props.handleError)  
    }
    return (
      <MuiThemeProvider>
